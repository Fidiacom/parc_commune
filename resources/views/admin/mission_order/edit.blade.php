        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.mission_order.return', $missionOrder->getId()) }}" method="post">
                        @csrf
                    ...
                    <form action="{{ route('admin.mission_order.update', Crypt::encrypt($missionOrder->getId())) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('vehicule') is-invalid @enderror" data-toggle="select2" style="width: 100%" name="vehicule">
                                ...
                                @foreach ($vehicules as $v)
                                    <option value="{{ $v->getId() }}" @selected($v->getId() == $missionOrder->getVehiculeId())>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('driver') is-invalid @enderror" data-toggle="select2" style="width: 100%" name="driver">
                                ...
                                @foreach ($drivers as $d)
                                    <option value="{{ $d->getId() }}" @selected($d->getId() == $missionOrder->getDriverId())>{{ ($d->getFirstNameFr() ?: $d->getFirstNameAr() ?: '') . ' ' . ($d->getLastNameFr() ?: $d->getLastNameAr() ?: '') . ' | ' . ($d->getCin() ?: '') }}</option>
                                @endforeach
                            </select>
                            @error('driver')
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="customCheck3" name="mission_order_type" @checked($missionOrder->getPermanent()) onchange="togglePermanentFields()">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control date @error('start_date') is-invalid @enderror" name="start_date" value="{{ old('start_date', $missionOrder->getStart()) }}">
                            @error('start_date')
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group mb-3" id="end_date_group">
                            ...
                            <input type="date" class="form-control date @error('end_date') is-invalid @enderror" name="end_date" id="end_date" value="{{ old('end_date', $missionOrder->getEnd()) }}">
                            @error('end_date')
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="datetime-local" id="registration_datetime" class="form-control @error('registration_datetime') is-invalid @enderror" name="registration_datetime" value="{{ old('registration_datetime', $missionOrder->getRegistrationDatetime() ? date('Y-m-d\TH:i', strtotime($missionOrder->getRegistrationDatetime())) : '') }}">
                        ...
                        <div class="card mb-3" id="mission_section">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mission_fr" class="form-control @error('mission_fr') is-invalid @enderror" name="mission_fr" placeholder="{{ __('Mission in French') }}" value="{{ old('mission_fr', $missionOrder->getMissionFr()) }}">
                                    @error('mission_fr')
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mission_ar" class="form-control @error('mission_ar') is-invalid @enderror" name="mission_ar" placeholder="{{ __('Mission in Arabic') }}" dir="rtl" value="{{ old('mission_ar', $missionOrder->getMissionAr()) }}">
                                    @error('mission_ar')
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="card mb-3" id="place_togo_section">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="place_togo_fr" class="form-control @error('place_togo_fr') is-invalid @enderror" name="place_togo_fr" placeholder="{{ __('Place to Go in French') }}" value="{{ old('place_togo_fr', $missionOrder->getPlaceTogoFr()) }}">
                                    @error('place_togo_fr')
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="place_togo_ar" class="form-control @error('place_togo_ar') is-invalid @enderror" name="place_togo_ar" placeholder="{{ __('Place to Go in Arabic') }}" dir="rtl" value="{{ old('place_togo_ar', $missionOrder->getPlaceTogoAr()) }}">
                                    @error('place_togo_ar')
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
