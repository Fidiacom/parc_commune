                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="role_ar" class="form-control @error('role_ar') is-invalid @enderror" name="role_ar" placeholder="{{ __('Role in Arabic') }}" dir="rtl" value="{{ old('role_ar') }}">
                                        @error('role_ar')
                                        <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="role_fr" class="form-control @error('role_fr') is-invalid @enderror" name="role_fr" placeholder="{{ __('Role in French') }}" value="{{ old('role_fr') }}">
                                        @error('role_fr')
                                        <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
